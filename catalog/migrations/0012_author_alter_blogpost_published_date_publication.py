...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalog', '0011_alter_blogpost_options_alter_blogpost_image'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('association', models.ManyToManyField(blank=True, to='catalog.association')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.ManyToManyField(blank=True, to='catalog.topic')),
            ],
            options={
